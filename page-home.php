...
$peoject_features_title         = get_field('project_feature_title');
$peoject_features_body         = get_field('project_feature_body');
...
<section id="project-features">
    <div class="container">
        ...
        <h2><?php echo $peoject_features_title; ?></h2>
        <p class="lead"><?php echo $peoject_features_body; ?></p>
